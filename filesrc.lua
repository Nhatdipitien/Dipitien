...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>pitiên chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "pitiên", HidePremium = false, IntroText = "pitiên⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("pitiên SCRIPT")
W:AddLabel("Discordpitiên")
local Section = W:AddSection({
    Name = "Status"
})
